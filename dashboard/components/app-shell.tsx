...
import { Bell, CircleHelp, Clock3, LayoutDashboard, Radar, ScanSearch, UserRound } from "lucide-react"
      ...
      <div className="lg:pl-64">
        <header className="sticky top-0 z-20 flex h-18 items-center justify-between border-b border-border bg-background/90 px-4 backdrop-blur-xl md:px-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <Tooltip><TooltipTrigger render={<Button variant="ghost" size="icon" aria-label="Profile"><UserRound /></Button>} /><TooltipContent side="bottom">Profile</TooltipContent></Tooltip>
